...
export const mockListings: ListingRecord[] = [
  ...
  },
  {
    ...
    rooms: [
      { name: "Стандарт", capacity: 2, price: 1500 },
      { name: "Люкс", capacity: 4, price: 3000 },
    ],
    meals: ["Завтрак"],
  ...
  },
  {
    ...
    images: [],
    housingType: "separate_rooms",
    subtype: "room_in_apartment",
    city: "Бахчисарай",
    ...
    updatedAt: new Date("2024-07-16").toISOString(),
  },
];

export const mockCalendars: ActivityCalendarRecord[] = [];

export const mockListingCalendars: ListingCalendarRecord[] = [
  {
